...
from utils.print_utils import rich_transcription_postprocess, rich_print_asr_res
...
def main():
    ...
    use_itn = True # punctuation prediction
    max_len = 256

    model_path_root = os.path.join(os.path.dirname(__file__), "models")
